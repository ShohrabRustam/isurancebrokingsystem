        ...
        <div class="row">
          <div class="row home-tile">
            <div class="col-sm-6 home-title-text">
              <div class="row">
                <h2>Salil</h2>
                <p>The services provided by mBrockage are extremely helpful in making the right choice.
          ...
          <div class="row home-tile">
            ...
            <div class="col-sm-6 home-title-text">
              <div class="row">
                <h2>Ajay </h2>
                <p>Thanking you very much for your support for getting our policy quickly, I would appreciate your work.</p>
              </div>
            </div>
          </div>
          <div class="container">
            <div class="row home-tile">
              <div class="col-sm-6 home-title-text">
                <div class="row">
                  <h2>Santosh  &amp; customers.</h2>
                  <p>I would like to thank the website 'www.mBrockage.com' because of which i could get a good policy.
